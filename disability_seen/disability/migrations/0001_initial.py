    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cast_members', models.ManyToManyField(to='disability.cast')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='disability.movie')),
            ],
        ),
    ]
